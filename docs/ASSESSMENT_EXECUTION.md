...
| U11 | `claude/assess-u11-repo-slim` | Remove mockups + design-handoff binaries from working tree (NO history rewrite — owner decision), dead frontend code, one-off scripts, irrelevant reference docs (§3, P3.13) | pushed, in review (60.9 MB reclaimed; detectFixedCosts kept — live mirror script) | — |
